    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Register to manage opportunities</p>
        </div>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-rwanda-green"
                placeholder="admin@korarwanda.com"
                required
              />
            </div>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link to="/admin/login" className="text-rwanda-green font-semibold hover:underline">
              Login here
            </Link>
          </p>
        </div>
